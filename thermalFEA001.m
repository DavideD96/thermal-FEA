...
substrate_length = 0.005*magnification;
...
q = 50; %internal heat source = rho*j^2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figure
im = pdeplot3D(tmodel,ColorMapData=T);
...
spacing = 0.02;
[DX,DY,DZ] = gradient(T,spacing);
pdeplot3D(tmodel,FlowData=[DX,DY,DZ]);